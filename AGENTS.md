...
- **MCP server**: auto-configured via `.mcp.json` (tools: `list_components`, `get_component`, `get_examples`, `get_design_tokens`, `search`, `get_usage_guidelines`). See `packages/agentic/readme.md`.
