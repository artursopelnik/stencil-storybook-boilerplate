...
const meta = {
  ...
  args: {
    ...
    content: "Yes. It adheres to the WAI-ARIA design pattern with proper button and region semantics.",
    open: false,
    disabled: false,
  },
} satisfies Meta<Args>
...
export const Default = {
  render: ({ heading, content, open, disabled }) =>
    html`<ssb-accordion-item heading=${heading} ?open=${open} ?disabled=${disabled} style="width: 24rem;">
      ${content}
    </ssb-accordion-item>`,
...
export const Open = {
  render: () =>
    html`<ssb-accordion-item heading="Shipping details" ?open=${true} style="width: 24rem;">
...
export const Disabled = {
  render: () =>
    html`<ssb-accordion-item heading="Unavailable section" ?disabled=${true} style="width: 24rem;">
